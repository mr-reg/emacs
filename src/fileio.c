...
{
  /* alien_send_message ((char*)"file-name-concat", nargs, args); */
...
/*       if (STRINGP (dir)) */
/* 	{ */
/*       /\* if (strstr(SSDATA(name), "empty.el" )) { *\/ */
/*       /\* 	printf("here2 %s\n", SSDATA(dir)); *\/ */
/*       /\* } *\/ */
...
/*   if (strstr(SSDATA(name), "empty.el" )) { */
/*     printf("Vinvocation_directory %s\n", SSDATA(Vinvocation_directory)); */
/*   } */
